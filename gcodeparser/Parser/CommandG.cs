...
namespace gcodeparser
{
    internal class CommandG: BaseCommand
    {
        public override void Parse()
        {
            ...
            switch (gType)
            {
                case -1: Logger.Info("G: no command"); return;
                ...
                default:
                    Logger.Info("G: Unsupported: {0}", gType);
                    break;
            }
        }
        ...
        private void Parse0()
        {
            Logger.Info("G00: Set Rapid Linear Motion mode.");
        ...
        private void Parse1()
        {
            Logger.Info("G01: Set linear interpolation mode.");
        ...
        private void Parse2()
        {
            Logger.Info("G02: Set circular/helical interpolation (clockwise) mode.");
        ...
        private void Parse3()
        {
            Logger.Info("G03: Set circular/helical interpolation (counter clockwise) mode.");
        ...
        {
            Logger.Info("G17: Select XY plane");
        ...
        {
            Logger.Info("G18: Select XZ plane");
        ...
        {
            Logger.Info("G19: Select YZ plane");
        ...
        {
            Logger.Info("G90: Set absolute distance mode");
        ...
        {
            Logger.Info("G91: Set incremental distance mode");
